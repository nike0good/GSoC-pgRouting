...
pgr_bar(text,anyarray,anyarray,boolean)
_pgr_bar(text,anyarray,anyarray,boolean,boolean,boolean,bigint)
pgr_bar(text,anyarray,bigint,boolean)
pgr_bar(text,bigint,anyarray,boolean)
pgr_bar(text,bigint,bigint,boolean)
